(function() {
    function f() {
        d(e.section).target.forEach(function(a) {
    ...
    var d = window.sg.common.$q
      ...
      , b = function(a) {
        ...
        this.handler = {
            resize: function() {
                c.toggleType && (c.ele.section.css({
                    height: ""
                }),
            ...
            clickClose: function(a) {
                a.preventDefault();
                c.ele.section.hide();
                c.ele.window.trigger("resize")
            }
        };
        this.init();
        b.instances.set(a, this)
    };
    ...
    window.sg.components.notice = {
        ...
        closeBanner: function(a) {
            a = void 0 === a ? !0 : a;
            d(e.section).target.forEach(function(c) {
                b.instances.has(c) && b.instances.get(c).closeBanner(a)
            })
        }
    };
    d.ready(f)
